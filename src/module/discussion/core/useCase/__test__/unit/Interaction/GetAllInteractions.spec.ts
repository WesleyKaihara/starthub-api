...
describe('GetAllInteractions', () => {
  ...
  it('should get all interactions', async () => {
    const interaction1 = Interaction.create(1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. 1');
    const interaction2 = Interaction.create(2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. 2');
    ...
    expect(interactions[0].message).toBe('Lorem ipsum dolor sit amet, consectetur adipiscing elit. 1');

    expect(interactions[1].discussionId).toBe(2);
    expect(interactions[1].message).toBe('Lorem ipsum dolor sit amet, consectetur adipiscing elit. 2');
  });
});
